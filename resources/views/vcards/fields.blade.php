                    ...
                    <div class="col text-md-start text-center">
                        ...
                        <div class="col">
                            <label class="button-label mx-2 button-style mt-2">
                                <input type="radio" name="button_style" class="btn btn-secondary button-style" value="1" {{ empty($dynamicVcard) || $dynamicVcard['button_style'] == 1 ? 'checked' : ''}}>
                                <span class="button-style-one btn btn-secondary">{{ __('messages.vcard.style_1') }}</span>
                            </label>
                            <label class="button-label mx-2 mb-3 button-style mt-2">
                                <input type="radio" name="button_style" class="btn btn-secondary rouned-0 button-style" value="2"{{ isset($dynamicVcard['button_style']) && $dynamicVcard['button_style'] == 2 ? 'checked' : '' }}>
                                <span class="button-style-two btn btn-secondary">{{ __('messages.vcard.style_2') }}</span>
                            </label>
                            <label class="button-label mx-2 button-style mt-2">
                                <input type="radio" name="button_style" class="btn btn-secondary button-style" value="3"{{ isset($dynamicVcard['button_style']) && $dynamicVcard['button_style'] == 3 ? 'checked' : '' }}>
                                <span class="button-style-three btn btn-secondary">{{ __('messages.vcard.style_3') }}</span>
                            </label>
                            <label class="button-label mx-2 button-style mt-2">
                                <input type="radio" name="button_style" class="btn btn-secondary button-style" value="4"{{ isset($dynamicVcard['button_style']) && $dynamicVcard['button_style'] == 4 ? 'checked' : '' }}>
                                <span class="button-style-four btn btn-secondary">{{ __('messages.vcard.style_4') }}</span>
                            </label>
                            <label class="button-label mx-2 button-style mt-2">
                                <input type="radio" name="button_style" class="btn btn-secondary button-style" value="5"{{ isset($dynamicVcard['button_style']) && $dynamicVcard['button_style'] == 5 ? 'checked' : '' }}>
                                <span class="button-style-five btn">{{ __('messages.vcard.style_5') }}</span>
                            </label>
                            <label class="button-label mx-2 button-style mt-2">
                                <input type="radio" name="button_style" class="btn btn-secondary button-style" value="6"{{ isset($dynamicVcard['button_style']) && $dynamicVcard['button_style'] == 6 ? 'checked' : '' }}>
                                <span class="button-style-six btn">{{ __('messages.vcard.style_6') }}</span>
                            </label>
                            <label class="button-label mx-2 button-style mt-5">
                                <input type="radio" name="button_style" class="btn btn-secondary button-style" value="7" {{ isset($dynamicVcard['button_style']) && $dynamicVcard['button_style'] == 7 ? 'checked' : '' }}>
                                <span class="button-style-seven btn">{{ __('messages.vcard.style_7') }}</span>
                            </label>
                            <label class="button-label mx-2 button-style mt-5">
                                <input type="radio" name="button_style" class="btn btn-secondary button-style" value="8" {{  isset($dynamicVcard['button_style']) && $dynamicVcard['button_style'] == 8 ? 'checked' : '' }}>
                                <span class="button-style-eight btn">{{ __('messages.vcard.style_8') }}</span>
                            </label>
                            <label class="button-label mx-2 button-style mt-5">
                                <input type="radio" name="button_style" class="btn btn-secondary button-style" value="9" {{  isset($dynamicVcard['button_style']) && $dynamicVcard['button_style'] == 9 ? 'checked' : '' }}>
                                <span class="button-style-nine btn">{{ __('messages.vcard.style_9') }}</span>
                            </label>
                            <label class="button-label mx-2 button-style mt-5">
                                <input type="radio" name="button_style" class="btn btn-secondary button-style" value="10" {{  isset($dynamicVcard['button_style']) && $dynamicVcard['button_style'] == 10 ? 'checked' : '' }}>
