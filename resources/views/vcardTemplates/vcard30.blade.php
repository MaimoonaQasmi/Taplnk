        ...
        <div class="main-content mx-auto w-100 overflow-hidden bg-green">
            ...
            <div class="appointment-section pt-60 px-40">
                ...
                <div class="appointment">
                    ...
                    <div class="appointment">
                            <div class="row">
                                <div class="col-sm-2">
                                    <label class="mt-sm-3 mb-2 fw-5 text-white">{{ __('messages.date') }}:</label>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-2">
                                    <label class="mt-sm-3 mb-2 fw-5 text-white">{{ __('messages.hour') }}:</label>
                                </div>
                                <div class="col-sm-10">
                                    <div class="row">
                                        <div class="">
                    ...
                    <div class="blog-section pt-60 px-40">
                        ...
                        <div class="blog-slider">
                            @foreach ($vcard->blogs as $blog)
                                <div>
                                    <div class="blog-card d-flex flex-sm-row flex-column align-items-center gap-4">
                                        <div class="card-img">
            ...
            <div class="btn-section cursor-pointer">
                <div class="fixed-btn-section">
                    <div class="bars-btn taxi-bars-btn">
