    ...
    <div class="col-lg-4">
        <div class="row">
            ...
            <div class="col-lg-12 col-md-6 col-12 mb-7">
                ...
                {!! Form::number('storage_limit', isset($plan) ? $plan->storage_limit : 200, ['class' => 'form-control', 'placeholder' => __('messages.plan.storage_limit')]) !!}
            </div>
        </div>
        <div class="row">
            ...
            <div class="row mb-5">
                ...
                <div class="col-xxl-6 col-lg-12 col-md-4 col-6 mb-5 col-xs p-0">
                    <label class="form-label form-check p-0">
                        <input class="form-check-input feature mx-2" type="checkbox" value="1"
                               name="custom_qrcode" {{ (isset($feature) && $feature->custom_qrcode == 1) ? 'checked' : '' }}/>
                ...
                <div class="col-xxl-6 col-lg-12 col-md-4 col-6 mb-5 col-xs p-0">
                    <label class="form-label form-check p-0">
                        <input class="form-check-input feature mx-2" type="checkbox" value="1"
                               name="iframes" {{ (isset($feature) && $feature->iframes == 1) ? 'checked' : '' }}/>
                ...
                <div class="col-xxl-6 col-lg-12 col-md-4 col-6 mb-5 col-xs p-0">
                    <label class="form-label form-check p-0">
                        <input class="form-check-input feature mx-2" type="checkbox" value="1"
                               name="dynamic_vcard" {{ (isset($feature) && $feature->dynamic_vcard == 1) ? 'checked' : '' }}/>
