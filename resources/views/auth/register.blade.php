                            ...
                            <form method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mb-4">
                                        ...
                                        {{ Form::tel('contact', getDefaultPhoneCode() , ['class' => 'form-control', 'placeholder' => __('messages.form.contact'), 'onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")', 'id' => 'phoneNumber']) }}
